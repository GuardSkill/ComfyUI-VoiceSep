...
def fn_clearvoice_se(input_wav, model):
    if model == "FRCRN_16000Hz":
        myClearVoice = ClearVoice(task='speech_enhancement', model_names=['FRCRN_SE_16K'])
        fs = 16000
    elif model == "MossFormerGAN_16000Hz":
...
def fn_clearvoice_sr(input_wav, apply_se):
    ...
    fs = 48000
    if apply_se:
        new_wavname = wavname.replace('.wav', str(random.randint(0,100))+'.wav')
...
se_demo = gr.Interface(
    ...
    inputs = [
        ...
        gr.Dropdown(
            ["FRCRN_16000Hz", "MossFormerGAN_16000Hz", "MossFormer2_48000Hz"], value="MossFormer2_48000Hz", multiselect=False, info="Choose a speech enhancement model."
        ),
    ],
    outputs = [
        gr.Audio(label="Output Audio", type="filepath"),
    ],
    title = "<a href='https://github.com/modelscope/ClearerVoice-Studio' target='_blank'>ClearerVoice-Studio<a/>: 语音增强（语音降噪）",
    description = ("ClearerVoice-Studio ([Github仓库](https://github.com/modelscope/ClearerVoice-Studio)) 是一个AI驱动的语音处理工具平台，语音增强模块可从背景噪声中提取清晰语音，提升语音质量。它支持16 kHz和48 kHz的音频输出以及多种音频格式。 上传您的音频、或者点击其中一个示例，来尝试一下吧。"
                    "ClearerVoice-Studio ([Github Repo](https://github.com/modelscope/ClearerVoice-Studio)) is AI-powered and extracts clear speech from background noise for enhanced speech quality. It supports both 16 kHz and 48 kHz audio outputs. "
    ...
    examples = [
        ["examples/mandarin_speech_16kHz.wav", "FRCRN_16000Hz"],
        ["examples/mandarin_speech_16kHz.wav", "MossFormerGAN_16000Hz"],
        ["examples/english_speech_48kHz.wav", "MossFormer2_48000Hz"],
    ],
...
ss_demo = gr.Interface(
    ...
    title = "<a href='https://github.com/modelscope/ClearerVoice-Studio' target='_blank'>ClearerVoice-Studio<a/>: 语音分离",
    description = ("ClearerVoice-Studio ([Github仓库](https://github.com/modelscope/ClearerVoice-Studio)) 是一个AI驱动的语音处理工具平台，语音分离模块可从混合音频中分离出单独的语音。它支持16 kHz的音频输出和两个输出流。上传您的音频、或者点击其中一个示例，来尝试一下吧。"
                    "ClearerVoice-Studio ([Github Repo](https://github.com/modelscope/ClearerVoice-Studio)) is powered by AI and separates individual speech from mixed audio. It supports 16 kHz and two output streams. "
                    "To try it, simply upload your audio, or click one of the examples. "),
...
tse_demo = gr.Interface(
    ...
    title = "<a href='https://github.com/modelscope/ClearerVoice-Studio' target='_blank'>ClearerVoice-Studio<a/>: 音视频说话人提取",
    description = ("ClearerVoice-Studio ([Github仓库](https://github.com/modelscope/ClearerVoice-Studio)) 是一个AI驱动的语音处理工具平台，音视频说话人提取模块通过面部识别从多语者视频中提取每个说话者的语音以及图像。上传您的视频、或者点击其中一个示例，来尝试一下吧。"
                    "ClearerVoice-Studio ([Github Repo](https://github.com/modelscope/ClearerVoice-Studio)) is AI-powered and extracts each speaker's voice from a multi-speaker video using facial recognition. "
...
sr_demo = gr.Interface(
    ...
    title = "<a href='https://github.com/modelscope/ClearerVoice-Studio' target='_blank'>ClearerVoice-Studio<a/>: 语音超分辨率",
    description = ("ClearerVoice-Studio ([Github仓库](https://github.com/modelscope/ClearerVoice-Studio)) 是一个AI驱动的语音处理工具平台，语音超分辨率模块可将低分辨率音频（有效采样率≥16 kHz）转换为清晰、高清的48 kHz音频。它支持大多数音频格式。"
                    "ClearerVoice-Studio ([Github Repo](https://github.com/modelscope/ClearerVoice-Studio)) is AI-powered and transform low-resolution audio (effective sampling rate ≥ 16 kHz) into crystal-clear, high-resolution audio at 48 kHz. It supports most of audio types. "
                   "To try it, simply upload your audio, or click one of the examples. "),
    article = ("<p style='text-align: center'><a href='https://arxiv.org/abs/2206.07293' target='_blank'>FRCRN: Boosting Feature Representation Using Frequency Recurrence for Monaural Speech Enhancement (ICASSP 2022) </a> </p>"
              "<p style='text-align: center'><a href='https://arxiv.org/abs/2312.11825' target='_blank'>MossFormer2: Combining Transformer and RNN-Free Recurrent Network for Enhanced Time-Domain Monaural Speech Separation, (ICASSP 2024) </a> </p>"
